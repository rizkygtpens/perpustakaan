...
class Book(models.Model):
    ...
    author = models.ForeignKey('Author', on_delete=models.SET_NULL, null=True, verbose_name='Pengarang')
    ...
    def display_genre(self):
        """Create a string for the Genre. This is required to display genre in Admin. Max 3 genre"""
